...
resulting dataset is 1868 rows by 19 columnns. The data are not tidy,
given that the route variable could be organized in a way that is more
readable, combining the different routes into condensed columns.

There are 465 distinct stations. 84 of the stations are ADA compliant
and 69 out of 183 station entrance/exits without vending, or 0.3770492,
do allow entrance.
